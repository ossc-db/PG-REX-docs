...
本マニュアルは、PostgreSQL-REX14(以降、PG-REXと呼ぶ)の技術情報を説明します。本マニュアルの目的は、読者が、PG-REXの動作環境を構築し、PG-REXを操作できるようになることです。
...
PostgreSQL 14付属ドキュメント

-   [https://www.postgresql.jp/document/14](https://www.postgresql.jp/document/14)
